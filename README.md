...
JavaScript bindings for the [SolidityPP compiler](https://github.com/vitelabs/soliditypp/).

Uses the Emscripten compiled Solidity found in the [solppc-bin repository](https://github.com/vitelabs/soliditypp/releases).

## Node.js Usage

To use the latest stable version of the SolidityPP compiler via Node.js you can install it via npm:
...
```bash
solppcjs --bin --include-path node_modules/ --base-path . MainContract.sol
```
...
```
var translate = require('solppc/translate')
